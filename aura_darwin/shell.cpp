...
//               pimage->get_graphics()->fill_rectangle(i32_rectangle(d->size()), argb(123, colorref_get_r_value(crBk), colorref_get_g_value(crBk), colorref_get_b_value(crBk)));
...
//         {
//
//            estatus = constructø(m_pshell, __new(::freebsd::shell));
//
//            if (!estatus)
//            {
//
