...
//#endif
      ...
      //void call_async(const ::string & pszPath, const ::string & pszParam, const ::string & pszDir, ::e_display edisplay, bool bPrivileged, ::u32 * puiPid = nullptr) override;
      ...
      //void create_process(const string_base<char> & str, ::u32 * puId) override;
