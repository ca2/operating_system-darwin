...
//                     m_size.cx(), m_size.cy());
   ...
   //   register huge_integer huge_int_size = size / 64;
   //   unsigned char * lpb = (unsigned char *) m_pcolorref;
   //   lpb += ((int)echannel) % 4;
   //   register huge_integer i = 0;
   //   for(; i < huge_int_size; i++)
   //   {
   //      lpb[4 *  0] = 255 - lpb[4 *  0];
   //      lpb[4 *  1] = 255 - lpb[4 *  1];
   //      lpb[4 *  2] = 255 - lpb[4 *  2];
   ...
   //void image::Blend (::image * pimage, int A )
   //{
   //   if ( size()!=pimage->size() )
   //      return;
   ...
   //void image::copy (::image * pimage, int x, int y )
   //{
   //   // Clip Rect
   //   int px=(x>=0) ? x : 0;
   //   int py=(y>=0) ? y : 0;
   ...
   //void image::PasteRect (::image * pimage, int x, int y )
   //{
   //   // Clip Rect
   //   int px=(x>=0) ? x : 0;
   //   int py=(y>=0) ? y : 0;
   ...
   //void image::BlendRect (::image * pimage, int x, int y, int A )
   //{
   //   // Clip Rect
   //   int px=(x>=0) ? x : 0;
   //   int py=(y>=0) ? y : 0;
   ...
   //void image::DarkenRect (::image * pimage, int x, int y )
   //{
   //   // Clip Rect
   //   int px=(x>=0) ? x : 0;
   //   int py=(y>=0) ? y : 0;
   ...
   //void image::DifferenceRect (::image * pimage, int x, int y )
   //{
   //   // Clip Rect
   //   int px=(x>=0) ? x : 0;
   //   int py=(y>=0) ? y : 0;
   ...
   //void image::LightenRect (::image * pimage, int x, int y )
   //{
   //   // Clip Rect
   //   int px=(x>=0) ? x : 0;
   //   int py=(y>=0) ? y : 0;
   ...
   //void image::MultiplyRect (::image * pimage, int x, int y )
   //{
   //   // Clip Rect
   //   int px=(x>=0) ? x : 0;
   //   int py=(y>=0) ? y : 0;
   ...
   //void image::ScreenRect (::image * pimage, int x, int y )
   //{
   //   // Clip Rect
   //   int px=(x>=0) ? x : 0;
   //   int py=(y>=0) ? y : 0;
...
//   }
   ...
   bool image::update_window(::user::user::interaction_impl * puserinteraction, ::message::message * pmessage)
   {
      ...
      huge_int_rectangle rectangleWindow;
