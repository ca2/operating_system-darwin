...
namespace windowing_xcb
{
   ...
   public:
      ...
      virtual bool get_monitor_rectangle(index iMonitor, INT_RECTANGLE * prectangle);

      virtual bool get_workspace_rectangle(index iWorkspace, INT_RECTANGLE * prectangle);
